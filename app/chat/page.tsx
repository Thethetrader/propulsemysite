...
export default function ChatPage() {
  ...
  const handleKeyPress = (e: React.KeyboardEvent) => {
    if (e.key === 'Enter' && !e.shiftKey) {
          ...
          <div className="mb-6">
            ...
            {channels.map((channel) => (
              <div
                ...
                className={`flex items-center px-3 py-2 rounded-xl cursor-pointer mb-2 transition-all duration-200 group ${
      ...
      {isRightSidebarOpen && (
        <div className="w-64 bg-white border-l border-gray-100 animate-slide-in">
          <div className="p-6">
